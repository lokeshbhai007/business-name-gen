 ...
 * @param {string} [props.backdropBlurAmount] - The size of the backdrop blur to apply.
 * Valid values are "none", "sm", "md", "lg", "xl", "2xl", "3xl".
 * Defaults to "sm" if not provided.
 * @param {string} [props.color] - The color of the shader's glow in hexadecimal format (e.g., "#RRGGBB").
 * Defaults to "#07eae6ff" (cyan) if not provided.
